...
- [ ] **5. Runtime stability and resource-lifecycle deep audit.** Re-audit long-running resource ownership, teardown, cache/streaming pressure, failure recovery, memory growth and crash handling from the public 2.0 installation and current `main`.
...
Start with **Domain 5 — runtime stability and resource lifecycle** because failures there can invalidate rendering, creator workflow, multiplayer and packaging confidence at once. Prefer public-install and maintained real-game workloads over synthetic feature counting.
