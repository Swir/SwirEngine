...
Any RED check keeps Milestone 10 open. Fix the smallest justified defect, re-run the exact-head
matrix, and preserve **9/10 = 90.0%** until the complete Phase A contract passes. Do not widen
feature scope while a release-readiness regression is active.
